...
async def can_device_add_song(
    db: AsyncSession, venue_id: int, fingerprint: str, max_songs: int
) -> bool:
...
async def get_device_active_count(
    db: AsyncSession, venue_id: int, fingerprint: str
) -> int:
