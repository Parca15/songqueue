...
class TestQueue:
    ...
    async def test_add_to_queue(self, client, super_headers):
        venue_id, token, song_id, song_yt = await self._setup_venue_and_song(
            client, super_headers
        )
        response = await client.post(
            f"/api/v1/queue/venue/{venue_id}/add",
            json={
                "youtube_id": song_yt,
    ...
    async def test_add_to_queue_limit(self, client, super_headers):
        ...
        await client.post(
            "/api/v1/songs",
            json={"youtube_id": "queue_song_2", "title": "Queue Song 2"},
        )
        await client.post(
            "/api/v1/songs",
            json={"youtube_id": "queue_song_3", "title": "Queue Song 3"},
        )
    ...
    async def test_add_duplicate_song(self, client, super_headers):
        ...
        await client.post(
            ...
            json={
                "youtube_id": song_yt,
                "device_fingerprint": "fp_dup_0001",
            },
        )
        response = await client.post(
            f"/api/v1/queue/venue/{venue_id}/add",
            json={
                "youtube_id": song_yt,
                "device_fingerprint": "fp_dup_0002",
            },
        )
    ...
    async def test_remove_requires_auth(self, client, super_headers):
        ...
        add_resp = await client.post(
            ...
            json={
                "youtube_id": song_yt,
                "device_fingerprint": "fp_remove_01",
            },
        )
    ...
    async def test_play_and_skip(self, client, super_headers):
        ...
        await client.post(
            "/api/v1/songs", json={"youtube_id": "play_song_2", "title": "Play Song 2"}
        )
        ...
        resp1 = await client.post(
            ...
            json={
                "youtube_id": song_yt,
                "device_fingerprint": "fp_play_0001",
            },
        )
        ...
        await client.post(
            ...
            json={
                ...
                "device_fingerprint": "fp_play_0002",
            },
        )
...
class TestWaiting:
    ...
    async def test_add_goes_to_waiting_by_default(self, client, super_headers):
        ...
        resp = await client.post(
            f"/api/v1/queue/venue/{venue_id}/add",
            json={
                "youtube_id": _uniq("wyt"),
                "device_fingerprint": "fp_wait_0001",
                "requested_by": "Carlos",
                "title": "Waiting Song",
            },
        )
    ...
    async def test_waiting_hidden_from_queue_state(self, client, super_headers):
        ...
        await client.post(
            ...
            json={
                "youtube_id": _uniq("wyt"),
                "device_fingerprint": "fp_wait_0002",
                "title": "S",
            },
        )
        ...
        waiting = (
            await client.get(f"/api/v1/queue/venue/{venue_id}/waiting", headers=H)
        ).json()
    ...
    async def test_approve_first_and_last(self, client, super_headers):
        ...
        r1 = await client.post(
            ...
            json={
                "youtube_id": yt1,
                "device_fingerprint": "fp_wait_0003",
                "requested_by": "Carlos",
                "title": "S1",
            },
        )
        r2 = await client.post(
            ...
            json={
                "youtube_id": yt2,
                "device_fingerprint": "fp_wait_0004",
                "requested_by": "Ana",
                "title": "S2",
            },
        )
        await client.post(
            f"/api/v1/queue/venue/{venue_id}/waiting/{r1.json()['id']}/approve",
            json={"position": "last"},
            headers=H,
        )
        await client.post(
            f"/api/v1/queue/venue/{venue_id}/waiting/{r2.json()['id']}/approve",
            json={"position": "first"},
            headers=H,
        )
        state = (await client.get(f"/api/v1/queue/venue/{venue_id}")).json()
        ...
        missing = await client.post(
            f"/api/v1/queue/venue/{venue_id}/waiting/999999/approve",
            json={"position": "last"},
            headers=H,
        )
    ...
    async def test_reject_waiting(self, client, super_headers):
        ...
        r = await client.post(
            ...
            json={
                "youtube_id": _uniq("wyt"),
                "device_fingerprint": "fp_wait_0005",
                "title": "S",
            },
        )
        item_id = r.json()["id"]
        rej = await client.post(
            f"/api/v1/queue/venue/{venue_id}/waiting/{item_id}/reject", headers=H
        )
    ...
    async def test_waiting_mine(self, client, super_headers):
        ...
        await client.post(
            ...
            json={
                "youtube_id": _uniq("wyt"),
                "device_fingerprint": "fp_wait_0006",
                "requested_by": "Carlos",
                "title": "S",
            },
        )
    ...
    async def test_register_name_duplicate(self, client, super_headers):
        ...
        ok = await client.post(
            f"/api/v1/venues/{venue_id}/register-name",
            json={
                "display_name": "Carlos",
                "device_fingerprint": "fp_wait_0007",
            },
        )
        ...
        dup = await client.post(
            ...
            json={
                "display_name": "carlos",
                "device_fingerprint": "fp_wait_0008",
            },
        )
    ...
    async def test_waiting_counts_toward_device_limit(self, client, super_headers):
        ...
        await client.post(
            ...
            json={
                "youtube_id": _uniq("wyt"),
                "device_fingerprint": "fp_wait_0009",
                "title": "S1",
            },
        )
